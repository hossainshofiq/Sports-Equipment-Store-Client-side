        ...
        <div className="navbar bg-primary text-primary-content fixed top-0 z-50">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        tabIndex={0}
                        className="menu menu-sm dropdown-content bg-gray-500 text-white rounded-box z-[50] mt-3 w-52 p-2 shadow"
                    >
                        {links}
                    </ul>
                </div>
                <Link to='/'><span className="btn btn-ghost text-xl">Sports Gear</span></Link>
            </div>
